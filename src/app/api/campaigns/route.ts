...
export async function POST(req: NextRequest) {
  ...
  await sql`
    INSERT INTO campaigns (id, partner_id, benefit_type_id, name, credit_value, cycle_type, headcount, budget_total, braze_canvas_id, min_order_value, validity_days, starts_at, ends_at)
    VALUES (
