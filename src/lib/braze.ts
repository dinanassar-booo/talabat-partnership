...
export async function triggerVoucherWalletCampaign(params: {
  ...
  const body = {
    ...
    canvas_entry_properties: {
      ...
      tcs_voucher_en: `AED ${creditValue} voucher from ${partnerName} - valid till ${validTillUTC.slice(0, 10)}`,
tcs_voucher_ar: `قسيمة ${creditValue} درهم من ${partnerName} - صالحة حتى ${validTillUTC.slice(0, 10)}`,
